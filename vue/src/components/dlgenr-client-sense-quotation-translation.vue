...
export default {
    ...
    computed : {
        piecesOfText(){
            ...
            let numberOfNodes = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('sense')[position].getElementsByTagName('cit')[positionOfQuotation].getElementsByTagName('cit')[0].getElementsByTagName('quote')[0].childNodes.length;
