...
export default {
    ...
    computed : {
        piecesOfText(){
            ...
            if (this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition] !== undefined){
                numberOfPieces = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes.length;
            }
            let piecesOfText = new Array();
            for (let i = 0; i < numberOfPieces; i++){
                if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i] !== undefined){
                    if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].nodeName == 'term'){
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == 'jpa'){
                            let termHebrew = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'jpa', 'text' : termHebrew, 'usage' : 'term'};
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == "grc"){
                            let greekTerm = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'grc', 'text' : greekTerm, 'usage' : 'term' };
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == "syc"){
                            let syriacTerm = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'syc', 'text' : syriacTerm, 'usage' : 'term' };
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == "fjb"){
                            let transcriptionTerm = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'fjb', 'text' : transcriptionTerm, 'usage' : 'term' };
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == "rabbinic"){
                            let rabbinicTerm = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'rabbinic', 'text' : rabbinicTerm, 'usage' : 'term' };
                            piecesOfText.push(piece);
                        }
                    }
                    else if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].nodeName === 'bibl'){
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('type') === 'ancient'){
                            let bibl = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'en', 'text' : bibl, 'usage' : 'bibl-ancient' };
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('type') === 'modern'){
                            let bibl = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'en', 'text' : bibl, 'usage' : 'bibl-modern' };
                            piecesOfText.push(piece);
                        }
                    }
                    else if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].nodeName == 'ref'){
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == 'jpa'){
                            let refHebrew = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'jpa', 'text' : refHebrew, 'usage' : 'ref'};
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == 'grc'){
                            let refGreek = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'grc', 'text' : refGreek, 'usage' : 'ref' };
                            piecesOfText.push(piece);
                        }
                        if(this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].getAttribute('xml:lang') == 'fjb'){
                            let refLatin = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].childNodes[0].nodeValue;
                            let piece = { 'language' : 'en', 'text' : refLatin, 'usage' : 'ref' };
                            piecesOfText.push(piece);
                        }
                    }
                    else {
                        let latinText = this.$props.entry.getElementsByTagName('entry')[0].getElementsByTagName('note')[this.$props.notePosition].childNodes[i].nodeValue;
